...
export class Backend implements backendInterface {
    ...
    async adminSignup(arg0: UserProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adminSignup(to_candid_UserProfile_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createReport(arg0: DailyServiceReport): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createReport(to_candid_DailyServiceReport_n7(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async signupWithRole(arg0: UserProfile, arg1: Role): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.signupWithRole(to_candid_UserProfile_n1(this._uploadFile, this._downloadFile, arg0), to_candid_Role_n3(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateUserRole(arg0: Principal, arg1: Role): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateUserRole(arg0, to_candid_Role_n3(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_DailyServiceReport_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DailyServiceReport): DailyServiceReport {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DailyServiceReport]): DailyServiceReport | null {
    return value.length === 0 ? null : from_candid_DailyServiceReport_n17(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Geolocation]): Geolocation | null {
...
function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        geolocation: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.geolocation)),
        nextPlanOfAction: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.nextPlanOfAction)),
...
function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DailyServiceReport>): Array<DailyServiceReport> {
    return value.map((x)=>from_candid_DailyServiceReport_n17(_uploadFile, _downloadFile, x));
}
...
function to_candid_DailyServiceReport_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DailyServiceReport): _DailyServiceReport {
